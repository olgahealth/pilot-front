  ...
  return (
    <div className="min-h-screen bg-slate-50/50 p-4 lg:p-6 font-sans text-slate-900">
      <div className="space-y-8 max-w-[1200px] mx-auto">
        ...
        {/* ── Reingreso por prestador + Ingresos por modalidad ── */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">

        {/* Reingreso por prestador (izquierda) */}
        <div className="rounded-xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
        ...
        {/* Ingresos hospitalarios por modalidad (derecha) */}
        <div className="rounded-xl bg-white shadow-sm ring-1 ring-slate-200 overflow-hidden">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <Building2 className="h-4 w-4 text-indigo-500" />
              <h2 className="text-base font-semibold text-slate-900">Ingresos hospitalarios por modalidad</h2>
              <Tip text="Número de pacientes de cada modalidad que requirieron ingreso hospitalario no planificado en el mes. La Rehabilitación debería estar en cero. PAD concentra los reingresos por ser pacientes crónicos de mayor complejidad." wide />
            </div>
            <span className="text-xs text-slate-400">Mayo 2026</span>
          </div>
          <div className="p-5">
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-slate-100">
                  ...
                  <th className="text-right pb-3 text-[10px] font-bold text-slate-400 uppercase tracking-wider">Pacientes activos</th>
              ...
              <tbody className="divide-y divide-slate-50">
                  ...
                  return (
                    <tr key={row.modalidad} className="hover:bg-slate-50/50 transition-colors">
                      ...
                      <td className="py-3.5 text-right">
                        <span className={`text-sm font-bold tabular-nums ${row.reingresos === 0 ? "text-emerald-600" : esAlerta ? "text-rose-600" : "text-amber-600"}`}>
                          {row.reingresos}
                        </span>
                      </td>
                      <td className="py-3.5 text-right">
                        <span className={`text-sm font-bold tabular-nums ${isOk ? "text-emerald-600" : "text-rose-600"}`}>
                          {tasa}%
                        </span>
                      </td>
                      <td className="py-3.5 text-right">
                ...
                <tr className="border-t border-slate-200 bg-slate-50/50">
                  ...
                  <td className="py-3 text-right">
                    <span className="text-[10px] font-bold bg-amber-100 text-amber-700 px-2 py-0.5 rounded-full">En meta</span>
                  </td>
                </tr>
              </tbody>
            </table>
            <p className="mt-4 text-xs text-slate-400 leading-relaxed">
              PAD concentra la mayor tasa de reingreso (18%) por la complejidad crónica de sus pacientes.
              La Rehabilitación en casa mantiene <strong className="text-emerald-600">0 reingresos</strong>, confirmando que el protocolo post-quirúrgico domiciliario es efectivo.
            </p>
          </div>
        </div>

        </div>{/* fin grid reingresos */}
